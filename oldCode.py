...
def model(points, s, t):
    ...
    #find 2-perms of all clusters
    #merge var to track total number of merges
    #function is called until no clusters are merged 
...
# points = np.random.normal(0, 10, (10, 2)) # for random stimuli gen -> change to fit 800 x 500 px 
# clustering = [0, 1, 0, 0, 0, 1, 1, 1, 1, 1]
